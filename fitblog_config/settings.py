...
MIDDLEWARE = [
    ...
    'products.middleware.UserProfileMiddleware',  # ← NEW: Auto-create UserProfile from session
]
...
SIMPLE_JWT = {
    ...
    'SLIDING_TOKEN_LIFETIME': __import__('datetime').timedelta(days=1),
    'SLIDING_TOKEN_REFRESH_LIFETIME': __import__('datetime').timedelta(days=7),
}